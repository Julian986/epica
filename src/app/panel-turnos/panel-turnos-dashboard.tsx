...
import { EPICA_BRAND_NAME } from "@/lib/epica-brand";
...
function whatsAppChatUrl(
  ...
  const text = `${greet}, te escribimos desde ${EPICA_BRAND_NAME} por tu turno: ${opts.treatmentName}, ${opts.displayDate} a las ${opts.timeLocal}.`;
        ...
        <header className="pb-2">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-[14px] text-gray-500">{EPICA_BRAND_NAME}</p>
            </div>
          </div>
