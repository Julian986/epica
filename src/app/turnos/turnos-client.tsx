      ...
      <main className="mx-auto w-full max-w-md px-4 pt-6 pb-24">
        ...
        <BookingPicker
          ...
          onTreatmentIdChange={(id) => {
            ...
            setSelectedServiceIds(id ? normalizeEpicaServiceIds([id]) : []);
            setSelectedTime("");
          }}
          ...
          selectedCountLabel={
            selectedServices.length > 1
              ? `${selectedServices.length} servicios en la misma visita`
              : undefined
          }
          selectedDurationLabel={selectedServices.length > 0 ? selectedDurationLabel : undefined}
