...
import type { AbundantHairChoice } from "@/lib/treatments/abundant-hair";
...
export type ReservationDoc = {
  ...
  /** Declaración de cabello abundante (solo turnos con lacio). */
  abundantHair?: AbundantHairChoice;
  /** Texto de precio de referencia al reservar (p. ej. total con recargo). */
...
export type CreateReservationInput = {
  ...
  serviceIds?: string[];
  /** Solo aplica si hay lacio en `serviceIds`. */
  abundantHair?: AbundantHairChoice;
};
